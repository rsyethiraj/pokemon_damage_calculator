...
class Pokemon {
public:
    Pokemon(const PokedexEntry* species,
            Nature nature,
    ...
    std::array<int, 6> computeStats(const PokedexEntry* species, Nature nature, std::array<int, 6>& EVs, const std::array<int, 6>& IVs, int level);
